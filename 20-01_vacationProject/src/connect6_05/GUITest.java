...
public class GUITest extends JFrame {
	...
	private ImageIcon xMark = new ImageIcon(Connect6Main.class.getResource("../images/xMark.png"));
	...
	private ImageIcon blackPlayer = new ImageIcon(Connect6Main.class.getResource("../images/blackPlayer.png"));
	private ImageIcon whitePlayer = new ImageIcon(Connect6Main.class.getResource("../images/whitePlayer.png"));
	private ImageIcon bluePlayer = new ImageIcon(Connect6Main.class.getResource("../images/bluePlayer.png"));
	private ImageIcon yellowPlayer = new ImageIcon(Connect6Main.class.getResource("../images/yellowPlayer.png"));
	private ImageIcon latelyBlackStone = new ImageIcon(Connect6Main.class.getResource("../images/blackStoneSelected.png"));
	private ImageIcon latelyWhiteStone = new ImageIcon(Connect6Main.class.getResource("../images/whiteStoneSelected.png"));
	private ImageIcon latelyYellowStone = new ImageIcon(Connect6Main.class.getResource("../images/yellowStoneSelected.png"));
	private ImageIcon latelyBlueStone = new ImageIcon(Connect6Main.class.getResource("../images/blueStoneSelected.png"));
	...
	private int beforeAdjX = 0;
	private int beforeAdjY = 0;
			...
			public void mousePressed(MouseEvent e) {
				...
				if(gameAl.isStone(adjX, adjY)) {
					...
					if(gameAl.getCurrentTurn() == 0) {
						stoneLabel[adjX - 1][adjY - 1].setIcon(player1LatelyStone);
					}
					else if(gameAl.getCurrentTurn() == 1) {
						stoneLabel[adjX - 1][adjY - 1].setIcon(player2LatelyStone);
					}
					
					if(gameAl.getAmount() >= 2) {
						if(gameAl.getAmount() % 4 == 0) {
							stoneLabel[beforeAdjX][beforeAdjY].setIcon(player2Stone);
						}
						else if(gameAl.getAmount() % 4 == 1) {
							stoneLabel[beforeAdjX][beforeAdjY].setIcon(player1Stone);
						}
						else if(gameAl.getAmount() % 4 == 2) {
							stoneLabel[beforeAdjX][beforeAdjY].setIcon(player1Stone);
						}
						else if(gameAl.getAmount() % 4 == 3) {
							stoneLabel[beforeAdjX][beforeAdjY].setIcon(player2Stone);
						}
					}
					beforeAdjX = adjX - 1;
					...
					if(gameAl.getAmount() % 4 == 1) {
						...
						player2Button.setBackground(new Color(245, 126, 23));
					}
					else if(gameAl.getAmount() % 4 == 3) {
						count = gameOp.getTimeLimit();
